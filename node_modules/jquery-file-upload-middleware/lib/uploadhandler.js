        ...
        form
            ...
            .on('file', function (name, file) {
                ...
                var fileInfo  = map[path.basename(file.path)],
                    ext       = fileInfo.name.substr(fileInfo.name.lastIndexOf('.'));
                fileInfo.name = crypto.createHash('sha1').update((new Date()).valueOf().toString() + Math.random().toString() + 'img').digest('hex') + ext;
